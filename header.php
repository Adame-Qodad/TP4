      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="Nationalite/listeNationalites.php">Liste des nationalitées</a>
              <a class="dropdown-item" href="Nationalite/formNatio.php?action=Ajouter">Ajouter une nationalitée</a>
            </div>
          </li>
        </ul>
